...
* Enhance data utilization by leveraging ontology structures using tools such as [mOWL](https://github.com/bio-ontology-research-group/mowl), knowledge graph embedding frameworks like [PyKEEN](https://github.com/pykeen/pykeen), [ProteinBRT](https://github.com/nadavbra/protein_bert) for protein sequence data, [BioBERT](https://github.com/dmis-lab/biobert) to embed OMIM gene and disease descriptions.
